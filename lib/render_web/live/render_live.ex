defmodule RenderWeb.RenderLive do
  ...
  def connected_mount(_params, _session, socket) do
    classes = get_classes()
    selected_class = "0"
    IO.puts("RenderLive connected_mount, classes: #{inspect classes}")
    {:ok, assign(socket, selected_class: selected_class, page: "render", classes: classes)}
  end
