defmodule Render.Classes do
  ...
  ## Examples
      ...
      iex> list_classes(user_id)
      [%Class{}, ...]

  """
  def list_classes(user_id) do

    # collect non-recurring classes list
    query = Ecto.Query.where(Class, owner_id: ^user_id)
